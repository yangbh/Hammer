...
class search_google:
	def __init__(self,word,limit,start):
		...
		self.userAgent="(Mozilla/5.0 (Windows; U; Windows NT 6.1;en-US; rv:1.9.2) Gecko/20140115 Firefox/9.6)"
		self.quantity="100"
		self.limit=limit
		self.counter=start
		self.api_key="AIzaSyBuBomy0n51Gb4836isK2Mp65UZI_DrrwQ"
		
	def do_search(self):  #"&hl=en&meta=&q=%40\""+self.word+"\"")
		h = httplib.HTTP(self.server)
		h.putrequest('GET', "/search?num="+self.quantity+"&start=" + str(self.counter) + "&hl=en&meta=&q=\"%2a%40" + self.word + "\"OR\"site%3A" + self.word + "\"") #"&hl=en&meta=&q=\"%40" + self.word + "\"OR\"site%3A" + self.word + "\"")#"%40topsec.com.cn"OR"site%3Atopsec.com.cn"
